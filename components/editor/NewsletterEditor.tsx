...
const NewsletterEditor = ({ userId = "default-user-id" }: NewsletterEditorProps) => {
  ...
  return (
    <div className="w-full xl:w-5xl root:bg-white rounded-3xl shadow-xl border-2 border-black dark:border-white p-12">
      <h1 className="text-3xl mb-12 text-center">
        Créer une Newsletter basée sur vos données
      </h1>
      ...
      <div className="mb-8">
        ...
        <input
          ...
          disabled={isLoading}
          className="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
        />
      ...
      <div className="mb-8">
        ...
        <textarea
          placeholder="Détaillé de thème de la newsletter, le ton à employer, l'objectif etc."
          value={prompt}
